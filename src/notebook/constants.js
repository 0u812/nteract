...
export const FIND_DIALOG = 'FIND_DIALOG';
export const FIND_IN_NOTEBOOK = 'FIND_IN_NOTEBOOK';
export const CLEAR_SEARCH_REPLACE_OVERLAY = 'CLEAR_SEARCH_REPLACE_OVERLAY';
export const REPLACE_IN_NOTEBOOK = 'REPLACE_IN_NOTEBOOK';
export const SET_CELL_SOURCE = 'SET_CELL_SOURCE';
export const SET_FOCUSED_CELL_EDITOR = 'SET_FOCUSED_CELL_EDITOR';
