...
type SetExecutionStateAction = { type: 'SET_EXECUTION_STATE', executionState: string };
...
type SetNotificationSystemAction = { type: 'SET_NOTIFICATION_SYSTEM', notificationSystem: Object };
function setNotificationsSystem(state: AppState, action: SetNotificationSystemAction) {
...
export default function handleApp(state: AppState = defaultAppState, action: AppAction) {
  switch (action.type) {
    case 'NEW_KERNEL':
